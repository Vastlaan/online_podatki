...
const Gradients = styled.div`
    ...
    &::after {
        ...
        right: 0;
        bottom: 0;
        background-image: linear-gradient(to bottom, rgba(52, 104, 151, .1) 50%, rgba(70, 141, 204, 0.9) );
    ...
    &::before {
        ...
        right: 0;
        bottom: 0;
        background-image:  linear-gradient(to bottom, rgba(70, 141, 204, .1) 90%, rgba(70, 141, 204, 0.9) ), url('/img/header_test.jpg');
...
const BackgroundVideo = styled.div<VideoProps>`
    ...
    &::before {
        ...
        right: 0;
        bottom: 0;
        background-image: linear-gradient(to bottom,rgba(70, 141, 204, .1) 10%, rgba(70, 141, 204, .3) 80%, rgba(70, 141, 204, 0.9) );
